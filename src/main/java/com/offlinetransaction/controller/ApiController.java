package com.offlinetransaction.controller;


import com.offlinetransaction.cryptography.ServerKeyHolder;
import com.offlinetransaction.models.*;
import com.offlinetransaction.service.*;
...
public class ApiController {
    ...
    @Autowired private MeshSimulator mesh;
    @Autowired private BridgeIngestion bridge;
    ...
    public Map<String, Object> meshGossip() {
        MeshSimulator.GossipResult r = mesh.gossipOnce();
        return Map.of(
    ...
    public ResponseEntity<?> ingest(
        ...
        BridgeIngestion.IngestResult r = bridge.ingest(packet, bridgeNodeId, hopCount);
